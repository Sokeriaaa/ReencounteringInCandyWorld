...
open class CottonCandyBushBlock(properties: Properties) : BushBlock(properties) {

    override fun codec(): MapCodec<CottonCandyBushBlock> {
        return CODEC
    }
    ...
    companion object {
        val CODEC: MapCodec<CottonCandyBushBlock> = simpleCodec { CottonCandyBushBlock(it) }
